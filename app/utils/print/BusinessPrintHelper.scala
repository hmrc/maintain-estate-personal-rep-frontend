  ...
  def apply(
    ...
    val add: Seq[AnswerRow] = Seq(
      ...
      bound.yesNoQuestion(
        ...
        "business.ukRegisteredCompanyYesNo",
        rts.UkRegisteredCompanyYesNoController.onPageLoad(NormalMode).url
      ),
      bound.conditionalStringQuestion(
        ...
        (
          rts.UkCompanyNameController.onPageLoad(NormalMode).url,
    ...
    val amend: Seq[AnswerRow] = Seq(
      ...
      bound.yesNoQuestion(
        UkRegisteredCompanyYesNoPage,
        "business.ukRegisteredCompanyYesNo",
        rts.UkRegisteredCompanyYesNoController.onPageLoad(CheckMode).url
      ),
      bound.conditionalStringQuestion(
        NamePage,
        UkRegisteredCompanyYesNoPage,
        ("business.ukCompanyName", "business.nonUkCompanyName"),
        (
          rts.UkCompanyNameController.onPageLoad(CheckMode).url,
          rts.NonUkCompanyNameController.onPageLoad(CheckMode).url
        )
      ),
      ...
      bound.yesNoQuestion(
        AddressUkYesNoPage,
        "business.addressUkYesNo",
        rts.AddressUkYesNoController.onPageLoad(CheckMode).url
      ),
