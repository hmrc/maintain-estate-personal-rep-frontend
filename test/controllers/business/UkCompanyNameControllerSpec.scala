...
class UkCompanyNameControllerSpec extends SpecBase with MockitoSugar {
  ...
  private val form: Form[String] = formProvider.withPrefix("business.ukCompanyName", 53)
  private val name = "Name"

  private lazy val nameRoute: String = routes.UkCompanyNameController.onPageLoad(NormalMode).url

  "UkCompanyName controller" must {
