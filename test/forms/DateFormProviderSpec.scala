...
class DateFormProviderSpec extends DateBehaviours with FakeEstatesApp {
  ...
  val form: Form[LocalDate] = new DateFormProvider(frontendAppConfig).withConfig(prefix, min)
