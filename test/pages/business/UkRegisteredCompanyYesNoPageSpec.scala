...
class UkRegisteredCompanyYesNoPageSpec extends PageBehaviours {

  "UkRegisteredYesNoPage" must {

    beRetrievable[Boolean](UkRegisteredCompanyYesNoPage)

    beSettable[Boolean](UkRegisteredCompanyYesNoPage)
